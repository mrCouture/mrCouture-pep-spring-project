 ...
 *
 * You should NOT make any modifications to this class. OK I won't
 */
@Entity
@Table(name="message")
//was going to rename all variables so JpaRepository cooperates better
//@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)//<--this can convert json to snake_case I think
